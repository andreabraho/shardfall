...
| WLD-07 | **Greybox the dungeon** as a floor tower: per-floor task, boss every third floor, shrine + bench after each boss | **[C→You]** | Reshaped 2026-09-20 on your note. Descends rather than ascends, so it does not read as the endgame Tower of Shards twice. Requirements FR-7.11–7.20; design [02](02-singleplayer-redesign.md) §10.1 |
