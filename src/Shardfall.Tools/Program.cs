using Shardfall.Tools.Commands;

namespace Shardfall.Tools;

/// <summary>
/// The project's command line tool. Run from the repo root:
/// <code>
///   dotnet run --project src/Shardfall.Tools -- validate
///   dotnet run --project src/Shardfall.Tools -- codegen
///   dotnet run --project src/Shardfall.Tools -- codegen --check
/// </code>
/// </summary>
