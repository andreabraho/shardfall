...
/// <code>
///   dotnet run --project src/Sohan.Tools -- validate
///   dotnet run --project src/Sohan.Tools -- codegen
///   dotnet run --project src/Sohan.Tools -- codegen --check
/// </code>
/// </summary>
